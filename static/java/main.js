...
function updateSite() {
    if (window.location.href.includes('?count=')) {
        ...
        window.location.href = '/?count=' + count + '&grandpas=' + grandpaAmount + '&cookieUpgrades=' + cookieUpgradeAmount;
        console.log('site updated');
    }
}

// updates the values of grandpa_amount, count and cookie if they are not defined(NaN), so that they can be interpreted and used in the script
...
if (urlParams.get('cookieUpgrades') === 'NaN') {
